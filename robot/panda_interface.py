...
try:
    ...
    from gripper import Robotiq85F,RG2,PandaGripper 
...
class RoboticsEnvironment():
    ...
    def initialize_params(self):
        ...
        '''
        self.gripper =PandaGripper(self)#RG2(self)##Robotiq85New(self)# Robotiq85F(self)#
        #start with gripper open
        self.gripper.openGripper()


        #get joint handles
        joint_names = ['/Panda/joint'+str(i) for i in range(1,8)]
        ...
        #get tip handle
        self.robotTip = self.sim.getObject('/Panda/tip')
        #get target handle
        self.robotTarget = self.sim.getObject('/Panda/target')
        #get base handle
        self.robotBase=self.sim.getObject('/Panda')
        ...
        self.fkMaxAccel = [fkAccel*math.pi/180]*7
        self.fkMaxJerk =[fkJerk*math.pi/180]*7
    ...
    def followPath(self, path):
        ...
        pl, _ = self.sim.getPathLengths(path, 7)
...
def main():
    ...
    initConfig =[-0.2986462497511342, -0.7776782599555265, 0.08853218495398467, -2.4615431355043365, 0.07536537529725791, 1.7022087074340175, 0.5459406940124072]
    #get a pick pose
