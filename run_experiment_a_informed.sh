...
SESSION="experiment_a_informed"

SIM_CMD="coppeliasim -h -GzmqRemoteApi.rpcPort=23001 scenes/example_a_pick_place.ttt"
PY_CMD="conda activate rpenv && python3 manipulator_informed_exploration.py"
...
while true; do
    ...
    PY_PID=\$(pgrep -f manipulator_informed_exploration.py)
    ...
    kill -9 $PY_PID #manipulator_informed_exploration.py
