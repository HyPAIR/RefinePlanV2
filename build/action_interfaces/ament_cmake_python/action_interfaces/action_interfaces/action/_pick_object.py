    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_Goal')
            logger.debug(
...
class Metaclass_PickObject_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PickObject_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickObject_SendGoal_Request(metaclass=Metaclass_PickObject_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_interfaces/PickObject_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'PickObject_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._pick_object import PickObject_Goal
...
class Metaclass_PickObject_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_interfaces.action import _pick_object
...
class PickObject_SendGoal(metaclass=Metaclass_PickObject_SendGoal):
    from action_interfaces.action._pick_object import PickObject_SendGoal_Request as Request
    from action_interfaces.action._pick_object import PickObject_SendGoal_Response as Response
...
class PickObject_GetResult_Response(metaclass=Metaclass_PickObject_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_interfaces/PickObject_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'PickObject_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._pick_object import PickObject_Result
...
class Metaclass_PickObject_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickObject_GetResult(metaclass=Metaclass_PickObject_GetResult):
    from action_interfaces.action._pick_object import PickObject_GetResult_Request as Request
    from action_interfaces.action._pick_object import PickObject_GetResult_Response as Response
...
class Metaclass_PickObject_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickObject_FeedbackMessage(metaclass=Metaclass_PickObject_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_interfaces/PickObject_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'PickObject_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_interfaces.action._pick_object import PickObject_Feedback
...
class Metaclass_PickObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.PickObject')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickObject(metaclass=Metaclass_PickObject):
    ...
    from action_interfaces.action._pick_object import PickObject_Goal as Goal
    # The result message defined in the action definition.
    from action_interfaces.action._pick_object import PickObject_Result as Result
    # The feedback message defined in the action definition.
    from action_interfaces.action._pick_object import PickObject_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_interfaces.action._pick_object import PickObject_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_interfaces.action._pick_object import PickObject_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_interfaces.action._pick_object import PickObject_FeedbackMessage as FeedbackMessage
