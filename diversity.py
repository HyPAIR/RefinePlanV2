...
if __name__ == "__main__":
    ...
    collections =['informed-exploration','random-exploration']#['example-a-random', 'example-a-informed','pick-place-random','pick-place-informed']#,'manipulator-informed-data']
