...
if __name__ == "__main__":
    ...
    random_logger = TransitionLogger(connection_string=connection_string,database_name="refine-plan-v2", collection_name='pick-place-random')
