...
SESSION="experiment_a_random"

SIM_CMD="coppeliasim -h -GzmqRemoteApi.rpcPort=23002 scenes/example_a_pick_place.ttt"
PY_CMD="conda activate rpenv && python3 manipulator_random_exploration.py"
