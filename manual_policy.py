...
policy = [act1, act2, act3, act4, act5, act6, act7, act8]
robot = RoboticsEnvironment()
robot.connect()
robot.initialize_params()
robot.HomeArm(initConfig=[-1.5708021642299306, 1.5708124107873083, -2.443460952792223, 0.8726616556125304, 1.5707974398473405, 1.0471975511966667])
